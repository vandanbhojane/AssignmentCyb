...
public class REvertDraggable {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement from = driver.findElement(By.xpath("//div[@id='revertable']"));

		WebElement to = driver.findElement(
				By.xpath("//body/div[@id='app']/div[1]/div[1]/div[2]/div[2]/div[2]/div[1]/div[4]/div[1]/div[2]/p[1]"));
		...
		if (textTo.equals("Dropped!")) {
			System.out.println("PASS: Source is dropped to target as expected Will Revert");
		} else {
			System.out.println("FAIL: Source couldn't be dropped to target as expected Will not Revert");
		}

		WebElement from1 = driver.findElement(By.xpath("//div[@id='notRevertable']"));

		WebElement to1 = driver.findElement(By.xpath("//body/div[@id='app']/div[1]/div[1]/div[2]/div[2]/div[2]/div[1]/div[4]/div[1]/div[2]/p[1]"));
